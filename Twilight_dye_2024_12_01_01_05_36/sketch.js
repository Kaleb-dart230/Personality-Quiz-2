...
function draw() {
  ...
  //this animates the shapes. you don't need to do anything with this, but be sure not to move or delete it.
  animateShapes();
...
//this is the brains of the function that animates the shapes. you will not need to change anything here.
